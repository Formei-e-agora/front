...
export default function api(state = initialState, action = {}) {
    switch (action.type) {
        ...
        case API_USER_DATA_FAILED:
            return { ...state, user: null, loading: { ...state.loading, user: false } };
        ...
        case API_PERSON_DATA_FAILED:
            return { ...state, person: null, loading: { ...state.loading, person: false } };
        ...
        case API_ADDRESS_DATA_FAILED:
            return { ...state, address: null, loading: { ...state.loading, address: false } };
        default:
            return state;
    }
}