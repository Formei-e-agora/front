...
const UpdateJobForm = (props) => {
    ...
    const onFinish = async (values) => {
        ...
        const json = await updateJob(props.data.jobId, { ...values, isRemote: !!(values.isRemote), professorId: userData.userId, isActive: true });
    ...
    useEffect(() => {
        if(props.data)
            form.setFieldsValue({ ...props.data, creationDate: moment(props.data.creationDate), closeDate: moment(props.data.closeDate) });
    }, []);
